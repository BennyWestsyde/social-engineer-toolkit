...
meta_path = '/Users/Shared/metasploit-framework/'                              # File path to metasploit - std SET msf_path = meta_path().
...
ino_output_filename = '/Users/Shared/setoolkit/src/teensy/ino_file_gen.ino'                                    # Filename of the final ino file containing the generated arduino code and xml build config for msbuild.
ino_header_filename = '/Users/Shared/setoolkit/src/teensy/ino_header.txt'                                      # File containg the header arduino code to be incorporated into the ino file before the xml build config.
ino_tail_filename  = '/Users/Shared/setoolkit/src/teensy/ino_tail.txt'                                         # File containg the header arduino code to be incorporated into the ino file after the xml build config.
xml_input_filename = '/Users/Shared/setoolkit/src/teensy/ino_build_file.xml'                                   # File containing the xml build structure to be incorporated into the ino file.
